...
$header .= "From: Новая заявка <danchik_fedorov@mail.ru>\n\n";	
$mail = mail("danchik_fedorov@mail.ru", $subject1, iconv ('utf-8', 'windows-1251', $message1), iconv ('utf-8', 'windows-1251', $header));
